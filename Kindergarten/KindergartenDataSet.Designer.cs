...
namespace Kindergarten {
    ...
    public partial class KindergartenDataSet : global::System.Data.DataSet {
        ...
        public partial class veliDataTable : global::System.Data.TypedTableBase<veliRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public veliRow AddveliRow(string ad, string soyad, string cinsiyet, string telno, string adres, string sifre) {
...
namespace Kindergarten.KindergartenDataSetTableAdapters {
    ...
    public partial class veliTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[veli] WHERE (([veliid] = @Original_veliid) AND ((@IsNull_ad = 1 AND [ad] IS NULL) OR ([ad] = @Original_ad)) AND ((@IsNull_soyad = 1 AND [soyad] IS NULL) OR ([soyad] = @Original_soyad)) AND ([cinsiyet] = @Original_cinsiyet) AND ((@IsNull_telno = 1 AND [telno] IS NULL) OR ([telno] = @Original_telno)) AND ((@IsNull_adres = 1 AND [adres] IS NULL) OR ([adres] = @Original_adres)) AND ((@IsNull_sifre = 1 AND [sifre] IS NULL) OR ([sifre] = @Original_sifre)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[veli] ([ad], [soyad], [cinsiyet], [telno], [adres], [sifre]) V" +
                "ALUES (@ad, @soyad, @cinsiyet, @telno, @adres, @sifre);\r\nSELECT veliid, ad, soya" +
                "d, cinsiyet, telno, adres, sifre FROM veli WHERE (veliid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[veli] SET [ad] = @ad, [soyad] = @soyad, [cinsiyet] = @cinsiyet, [telno] = @telno, [adres] = @adres, [sifre] = @sifre WHERE (([veliid] = @Original_veliid) AND ((@IsNull_ad = 1 AND [ad] IS NULL) OR ([ad] = @Original_ad)) AND ((@IsNull_soyad = 1 AND [soyad] IS NULL) OR ([soyad] = @Original_soyad)) AND ([cinsiyet] = @Original_cinsiyet) AND ((@IsNull_telno = 1 AND [telno] IS NULL) OR ([telno] = @Original_telno)) AND ((@IsNull_adres = 1 AND [adres] IS NULL) OR ([adres] = @Original_adres)) AND ((@IsNull_sifre = 1 AND [sifre] IS NULL) OR ([sifre] = @Original_sifre)));
SELECT veliid, ad, soyad, cinsiyet, telno, adres, sifre FROM veli WHERE (veliid = @veliid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT veliid, ad, soyad, cinsiyet, telno, adres, sifre FROM dbo.veli";
        ...
        public virtual int Fill(KindergartenDataSet.veliDataTable dataTable) {
        ...
        public virtual KindergartenDataSet.veliDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KindergartenDataSet.veliDataTable dataTable = new KindergartenDataSet.veliDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KindergartenDataSet.veliDataTable dataTable) {
        ...
        public virtual int Delete(int Original_veliid, string Original_ad, string Original_soyad, string Original_cinsiyet, string Original_telno, string Original_adres, string Original_sifre) {
        ...
        public virtual int Insert(string ad, string soyad, string cinsiyet, string telno, string adres, string sifre) {
            if ((ad == null)) {
        ...
        public virtual int Update(string ad, string soyad, string cinsiyet, string telno, string adres, string sifre, int Original_veliid, string Original_ad, string Original_soyad, string Original_cinsiyet, string Original_telno, string Original_adres, string Original_sifre, int veliid) {
            if ((ad == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_veliid));
            if ((Original_ad == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(veliid));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ad, string soyad, string cinsiyet, string telno, string adres, string sifre, int Original_veliid, string Original_ad, string Original_soyad, string Original_cinsiyet, string Original_telno, string Original_adres, string Original_sifre) {
            return this.Update(ad, soyad, cinsiyet, telno, adres, sifre, Original_veliid, Original_ad, Original_soyad, Original_cinsiyet, Original_telno, Original_adres, Original_sifre, Original_veliid);
        }
    }
